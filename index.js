...
function data_enter(sende_r, beacon_id) {
   ...
   var checktime = "https://script.google.com/macros/s/AKfycbyJGk3VwXxipNI6FyS6HedH6RpLBumq2lnXer8/exec?userId="+sende_r+"&beaconid="+beacon_id;
 ...
 request(options, function (error, response, body) {
    if (!error && response.statusCode == 200) {
        ...
        name = info.displayName;
          ...
          if(beacon_id == "0151558c47"){
         var msg = {
           "type": "text",
           "text": "ระบบได้บันทึกการตรวจจุดตรวจ ตลาดสดหนองบัว ของ"+" " +name +" " + "ไว้เรียบร้อยแล้ว"
